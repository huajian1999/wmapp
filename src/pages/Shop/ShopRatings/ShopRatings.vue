    ...
    <div class="ratings-content">
      ...
      <div class="ratingselect">
        ...
        <div class="switch" :class="{on:onlyText}">
          <span class="iconfont icon_check" @click="toggleOnlyText"></span>
        ...
        <ul>
          <li class="rating-item" v-for="(rating, index) in filterRatings" :key="index">
            ...
            <div class="content">
              ...
              <div class="recommend">
                <span class="iconfont" :class="rating.rateType?'icon_thumb-down':'icon_thumb-up'"></span>
...
export default{
    ...
    data(){
      return {
        onlyText:true, //是否只显示有文本内容的
        selectType:0, //选择的评价类型 0-满意，1-不满意，2-全部
      }
    },
    computed:{
        ...
        filterRatings(){
          ...
          return ratings.filter(rating => {
            ...
            onlyText:true/false  text:有值/""
            !onlyText || only && text ===> !onlyText || text
            */
            return (selectType === 2 || selectType === rateType) && (!onlyText || text);
          })
        }
    },
    methods:{
      ...
      .rating-item
        ...
        .content
          ...
          .recommend
            line-height: 16px
            font-size: 0
            .icon_thumb-up, .icon_thumb-down, .item
              display: inline-block
              margin: 0 8px 4px 0
              font-size: 10px
            .icon_thumb-up
