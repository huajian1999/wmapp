<template>
  <div class="shop-header">
    ...
    <div class="shop-content">
      ...
      <div class="header-content">
        <h2 class="content-title">
          ...
          <span class="content-name" @click="toggleShowShop">{{info.name}}</span>
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="toggleShowActives"><!--2.先获得数据再显示，不报错-->
      <div class="discounts-left">
        <div class="activity" :class="supportClasses[info.supports[0].type]"><!--1.报错，异步先获取初始数据，在获取包含了数据的数据-->
          <span class="content-tag">
    ...
    <div class="activity-sheet" v-show="showActives">
      <div class="activity-sheet-content">
        <h2 class="activity-sheet-title">优惠活动</h2>
        <ul class="list">
          <li v-for="(support,index) in info.supports" :key="index"
           class="activity-item" :class="supportClasses[support.type]">
            <span class="content-tag">
        ...
        <div class="activity-sheet-close" @click="toggleShowActives">
          <span class="iconfont icon_close"></span>
        </div>
      </div>
